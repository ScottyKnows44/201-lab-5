...
function multiply(a,b){ //eslint-disable-line
  var theanswer = a * b; 
  var message = 'The product of ' + a + ' and ' + b + ' is ' + theanswer + '.';
  return [theanswer, message];
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var theSumAB = sum(a, b);
  var theSumABC = sum(theSumAB[0],c);
  var theMathAB = multiply(a, b);
  var theMathABC = multiply(theMathAB[0],c);
  var message1 = a + ' and ' + b + ' and ' + c + ' sum to ' + theSumABC[0] + '.';
  var message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + theMathABC[0] + '.';  
  return [theSumABC,theMathABC, message1, message2]
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sum2[0] + ' is their sum.';
  console.log(message);
...
function multiplyArray(testArray){ //eslint-disable-line
  var answer1 = multiply(testArray[1],testArray[2])[0];
  var answer2 = multiply(answer1,testArray[0])[0];
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + answer2 + '.';
  console.log(message);
  console.log(answer1);
  console.log(answer2);
